...
#select_cols = ['snr','berv','airmass','vrad','biss','fwhm','sindex','H-alpha','Na I','CaI']
select_cols = ['berv','vrad','biss','fwhm','sindex','H-alpha','Na I','CaI']
...
#fig = marginals.corner(samples,labels=slabels,quantiles=[0.5],show_titles=True)
