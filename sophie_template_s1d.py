...
"""
    ...
    python /Volumes/Samsung_T5/Science/sophie/sophie_template.py --input=SOPHIE.202*s1d_A.fits --rv_file=TOI-1736_sophie_ccf.rdb --output=TOI-1736_template.fits -vn
    python /Volumes/Samsung_T5/Science/sophie/sophie_template.py --input=SOPHIE.202*s1d_A.fits --rv_file=TOI-2141_sophie_ccf.rdb --output=TOI-2141_template.fits -vn
    """
